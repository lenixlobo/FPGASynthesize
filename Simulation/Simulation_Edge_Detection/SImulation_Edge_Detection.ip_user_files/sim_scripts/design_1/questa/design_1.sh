...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="D:/Vivado_Sobel/SobelEdgeDetection/SobelEdgeDetection-master/Simulation/Simulation_Edge_Detection/SImulation_Edge_Detection.cache/compile_simlib/questa"
  fi
